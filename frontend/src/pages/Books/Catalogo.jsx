...
const Catalogo = () => {
	...
	const filtrarLivros = () => {
		return livros.filter((livro) => {
			const filtroCategoria = categoriaFiltro ? livro.categoria === categoriaFiltro : true;
								...
								>
									...
									<CardContent>
										...
										<Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
											{livro.sinopse ? `${livro.sinopse.slice(0, 40)}...` : "Sinopse não disponível."}
										</Typography>
									</CardContent>
									<CardActions sx={{ mt: "auto", justifyContent: "space-between" }}>
										...
										<Typography variant="caption" color={livro.disponivel ? "green" : "red"}>
